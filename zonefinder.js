  ...
  <body class="min-h-screen pb-28 selection:bg-blue-500/30">
      ...
      <script>
          ...
          function findBestSpot() {
              ...
              showDetail('2F', '閱覽室', 18, 32, 'Green', ['plug', 'lamp', 'wind'], true);
          }
  
          // Show Modal
          function showDetail(floor, name, occ, noise, status, amenities = [], isAutoPick = false) {
              ...
              // Special UI for Auto-Pick
              let headerHtml = '';
              if (isAutoPick) {
                  headerHtml = \`
                      <div class="mb-6 p-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-2xl shadow-lg shadow-purple-500/30 flex items-center justify-center gap-3 border border-white/20 relative overflow-hidden">
                          <div class="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20"></div>
                          <i class="ph-fill ph-sparkle text-yellow-300 text-2xl animate-bounce"></i>
                          <div class="text-center">
                              <p class="text-white font-black text-lg tracking-wide uppercase drop-shadow-md">Best Match Found</p>
                              <p class="text-purple-200 text-[10px] font-mono">AI Analysis Complete</p>
                          </div>
                          <i class="ph-fill ph-sparkle text-yellow-300 text-xl animate-pulse" style="animation-delay: 0.5s"></i>
                      </div>
                  \`;
              }
